  ...
  export const setUsers = (users: Array<UserType>): SetUsersActionTypeActionType => ({ type: SET_USERS, users });
  ...
  export const setToggleIsFetching = (isFetching: boolean): SetTotalIsFetchingActionType => ({
  ...
  export const setToggleIsProgress = (isFollowProgress: boolean, id: number): SetToggleProgressActionType => ({
